 ...
 *
 */
public class CrawlerThreadHelp {
    ...
    public Document commentAPI(String text,String music_id){
        //私钥，随机16位字符串（自己可改）
        ...
        try {
            //2次AES加密，得到params
            String params = CrawlerThreadHelp.encrypt(CrawlerThreadHelp.encrypt(text, nonce), secKey);
            ...
            //字符填充
            encSecKey= CrawlerThreadHelp.zfill(encSecKey, 256);
            //评论获取
